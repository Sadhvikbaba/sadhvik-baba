...
export default function BrowserFrame({ src, alt }: BrowserFrameProps) {
  return (
    <div className="relative w-full aspect-[16/10] sm:aspect-video rounded-xl sm:rounded-2xl overflow-hidden bg-[var(--color-sky-top)] border border-[var(--color-glass-border)] shadow-2xl flex flex-col group/browser">
      {/* Browser Chrome (Header) */}
      <div className="h-8 sm:h-10 w-full bg-[var(--color-glass-bg)] backdrop-blur-md border-b border-[var(--color-glass-border)] flex items-center px-4 gap-2 shrink-0">
